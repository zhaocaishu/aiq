...
if __name__ == '__main__':
    ...
    ts_dataset = TSDataset(data_dir='./data', save_dir='./tmp', instruments='csi1000', start_time='2020-01-01',
                           end_time='2023-05-31', adjust_price=False, seq_len=cfg.model.params.seq_len,
                           pred_len=cfg.model.params.pred_len, training=True)
    patch_tst = PatchTSTModel(model_params=cfg.model.params)
    patch_tst.fit(train_dataset=ts_dataset)
