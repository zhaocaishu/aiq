...
def parse_args():
    ...
    parser.add_argument('--prediction_file', type=str, default=None, help='file of predicted result')
...
if __name__ == '__main__':
    ...
    if args.prediction_file is None:
        ...
        df_prediction = pd.read_csv(os.path.join(args.data_dir, args.prediction_file))
        df_prediction = df_prediction[(cfg.dataset.segments['test'][0] <= df_prediction['Date']) & (df_prediction['Date'] <= cfg.dataset.segments['test'][1])]
