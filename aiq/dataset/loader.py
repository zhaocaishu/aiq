    ...
    def load_instrument_features(
        ...
        if data_dir:
            ...
            query = (
                ...
                "daily.`change` AS `Change`, daily.pct_chg AS Pct_Chg, daily.vol AS Volume, daily.amount AS AMount, "
    ...
    def load_market_features(
        ...
        if data_dir:
            ...
            query = (
                ...
                "`change` AS `Change`, pct_chg AS Pct_Chg, vol AS Volume, amount AS AMount "
