...
class Evaluator:
    ...
    def __init__(self, pred_col="PRED", label_col="LABEL", min_samples=50, top_k=30):
    ...
    def _compute_ic(self, group):
        """Calculate Spearman rank correlation coefficient (IC) for a group."""
        return (
    ...
    def evaluate(self, df, groupby_col="Date"):
        ...
        self._validate_columns(df, extra_cols=[groupby_col, "Instrument"])
        ...
        # Combine results
        results = {"Rank IC": ic_mean, "Rank ICIR": icir, **hr_mean}
